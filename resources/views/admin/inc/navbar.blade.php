                     ...
                     <ul class="notification-list">
                        <li class="notification-message">
                           <a href="activities.html">
                              <div class="media">
                                 <span class="avatar">
                                    <img alt="" src="{{asset('admin_assets/assets/img/profiles/avatar-02.jpg')}}">
                                 </span>
                        ...
                        <li class="notification-message">
                           <a href="activities.html">
                              <div class="media">
                                 <span class="avatar">
                                    <img alt="" src="{{asset('admin_assets/assets/img/profiles/avatar-03.jpg')}}">
                                 </span>
                                 <div class="media-body">
                        ...
                        <li class="notification-message">
                           <a href="activities.html">
                              <div class="media">
                                 <span class="avatar">
                                    <img alt="" src="{{asset('admin_assets/assets/img/profiles/avatar-06.jpg')}}">
                                 </span>
                                 <div class="media-body">
                        ...
                        <li class="notification-message">
                           <a href="activities.html">
                              <div class="media">
                                 <span class="avatar">
                                    <img alt="" src="{{asset('admin_assets/assets/img/profiles/avatar-17.jpg')}}">
                                 </span>
                                 <div class="media-body">
                        ...
                        <li class="notification-message">
                           <a href="activities.html">
                              <div class="media">
                                 <span class="avatar">
                                    <img alt="" src="{{asset('admin_assets/assets/img/profiles/avatar-13.jpg')}}">
                                 </span>
                                 <div class="media-body">
                        ...
                        <li class="notification-message">
                           <a href="chat.html">
                              <div class="list-item">
                                 <div class="list-left">
                                    <span class="avatar">
                                       <img alt="" src="{{asset('admin_assets/assets/img/profiles/avatar-09.jpg')}}">
                                    </span>
                                 </div>
                                 <div class="list-body">
                        ...
                        <li class="notification-message">
                           <a href="chat.html">
                              <div class="list-item">
                                 <div class="list-left">
                                    <span class="avatar">
                                       <img alt="" src="{{asset('admin_assets/assets/img/profiles/avatar-05.jpg')}}">
                                    </span>
                                 </div>
                                 <div class="list-body">
                        ...
                        <li class="notification-message">
                           <a href="chat.html">
                              <div class="list-item">
                                 <div class="list-left">
                                    <span class="avatar">
                                       <img alt="" src="{{asset('admin_assets/assets/img/profiles/avatar-08.jpg')}}">
                                    </span>
                                 </div>
                                 <div class="list-body">
