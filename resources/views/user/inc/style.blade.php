	<!-- Favicon -->
		...
		<!-- Lineawesome CSS -->
        <link rel="stylesheet" href="{{asset('admin_assets/assets/css/line-awesome.min.css')}}">

		<!-- Chart CSS -->
		<link rel="stylesheet" href="{{asset('admin_assets/assets/plugins/morris/morris.css')}}">
		<!-- Datetimepicker CSS -->
		<link rel="stylesheet" href="{{asset('admin_assets/assets/css/bootstrap-datetimepicker.min.css')}}">
		<!-- Main CSS -->
